...
- **Åtgärd:** Då miljön fortfarande är begränsad för att köra content-script, skapades en ny artikel manuellt (`article2.html`) om "Key PropTech Trends in 2026". Länk till artikeln har lagts till på startsidan (`index.html`). En `robots.txt` och `sitemap.xml` har skapats och lagts till i projektet.
