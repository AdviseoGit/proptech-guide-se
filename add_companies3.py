    ...
    new_companies = [
        {
            "name": "Hydda",
            "category": "plattform",
            "desc": "Proptech-grupp och plattform som samlar ledande proptech-lösningar för att ge fastighetsägare en helhetslösning för digitalisering.",
            "url": "https://hydda.io/"
        },
        {
            "name": "Infobric",
            "category": "sakerhet",
            "desc": "Digitala lösningar för bygg- och fastighetsbranschen med fokus på säkerhet, inpassering och hantering av maskiner och fordon.",
            "url": "https://infobric.se/"
        },
        {
            "name": "Flowbird",
            "category": "forvaltning",
            "desc": "Levererar smarta lösningar för parkering och mobilitet som integreras med fastigheter för optimerad parkeringsförvaltning.",
            "url": "https://flowbird.se/"
        },
        {
            "name": "Amido",
            "category": "sakerhet",
            "desc": "Pionjärer inom digital nyckelhantering och passersystem. Deras plattform Alliera integrerar olika passersystem till ett gränssnitt.",
            "url": "https://www.amido.se/"
        },
        {
            "name": "Propely",
            "category": "forvaltning",
            "desc": "Plattform för teknisk fastighetsförvaltning och drift som automatiserar och förenklar underhållsplanering, rondering och felanmälan.",
